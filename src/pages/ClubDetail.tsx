  ...
  return (
    <section className="py-20 min-h-screen flex flex-col md:flex-row items-center justify-center">
      <div className="md:w-1/2 flex justify-center items-center mb-8 md:mb-0">
        <img src={club.logo} alt={club.name} className="w-64 h-64 object-contain rounded-2xl shadow-luxury" loading="lazy" />
      </div>
      <div className="md:w-1/2 px-8">
        ...
        <div className="flex items-center gap-6">
          <img src={club.head.photo} alt={club.head.name} className="w-24 h-24 rounded-full object-cover shadow-lg" loading="lazy" />
          <div>
